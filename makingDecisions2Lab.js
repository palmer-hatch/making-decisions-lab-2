...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24,28,38,40,42];
// Do not edit the code above.
...
switch(lettergrade) {
  case 'B':
    console.log('If B: The student is doing well.');
    break;
    case 'C':
      console.log('If C: The student is doing alright.');
      break;
      case 'D':
    console.log('If D: The student is not doing very well.');
    break; 
    case 'F':
